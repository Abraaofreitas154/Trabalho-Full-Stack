...
Aplicação fullstack completa com frontend PWA (React + Vite) e backend Node.js (Express + Mongoose), implementando CRUD de produtos com persistência no MongoDB.
...
- [x] Nova entidade criada (Produto)
